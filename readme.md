# Вертска адаптивного, многостараничного сайта

* Адаптивно сверстал многостраничный сайт дизайн студии Agenzia. В проекте 7 страниц. Из них Главная, Работы, О нас, Каталог товаров, Карточка товара, Ошибка 404, Форум, а также Страница отдельного поста

## Старт проекта

### Склонируй репозиторий и перейди в папку проекта
```
git clone https://github.com/AdreeUA/agenzia.git new-project && cd new-project
```
